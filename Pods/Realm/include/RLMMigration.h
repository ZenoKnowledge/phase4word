...
/**
 ...
 @param ExampleName   The old name for the property to be renamed. There must not be a property with this name in the
 ...
 */
- (void)renamePropertyForClass:(NSString *)className ExampleName:(NSString *)ExampleName newName:(NSString *)newName;
