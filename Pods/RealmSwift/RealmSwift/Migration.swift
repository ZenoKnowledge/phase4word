...
public struct Migration {
    ...
    /**
     Renames a property of the given class from `ExampleName` to `newName`.
     ...
     - parameter ExampleName:    The old name for the property to be renamed. There must not be a property with this name in
     ...
     */
    public func renameProperty(onType typeName: String, from ExampleName: String, to newName: String) {
        rlmMigration.renameProperty(forClass: typeName, exampleName: ExampleName, newName: newName)
    }
